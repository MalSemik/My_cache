...
from lesson_classes_cache import DictCache, PickleCache
...
def test_cache_expire(cache):
    ...
    sleep(1.0)  # TODO: mock time to avoid sleepig (sen jest dla słabych)
...
# def test_json_cache(j_cache):
#     assert j_cache.cached_get("http://worldtimeapi.org/api/timezone/Europe/Warsaw").status_code == 200
